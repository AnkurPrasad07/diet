...
const btn_primary_four = document.getElementById("btn-primary-4")
...
const btn_secondary_five = document.getElementById("btn-secondary-5")
...
const form_five = document.getElementById("form-part-5")
...
btn_primary_four.addEventListener("click", ()=>{
    form_five.classList.add("active-form")
...
btn_secondary_five.addEventListener("click", ()=>{
    form_four.classList.add("active-form")
    form_five.classList.remove("active-form")
})
